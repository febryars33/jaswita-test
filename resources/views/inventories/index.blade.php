        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('inventories.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                            <i class="ti ti-plus"></i>
                            {{ __('Create') }}
                        </a>
                        <a href="{{ route('inventories.create') }}" class="btn btn-primary d-sm-none btn-icon">
                            <i class="ti ti-plus"></i>
                        </a>
                    </div>
                </div>
                                ...
                                <tbody>
                                    @foreach ($inventories as $inventory)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-muted">{{ optional($inventory->category)->name ?? 'N/A'; }}</span>
                                            </td>
                                            <td>
